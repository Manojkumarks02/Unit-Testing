...
import com.unitTesting.service.TestContainerConfiguration;
...
//        act and assert
        assertThatThrownBy(() -> employeeService.updateEmployee(mockEmployeeDto, 1L))
                .isInstanceOf(ResourceNotFoundException.class)
                .hasMessage("Employee not found with id: 1");
...
//        act and assert
        ...
        assertThatThrownBy(() -> employeeService.updateEmployee(mockEmployeeDto, mockEmployeeDto.getId()))
                .isInstanceOf(RuntimeException.class)
...
//        act
        EmployeeDto updatedEmployeeDto = employeeService.updateEmployee(mockEmployeeDto, mockEmployeeDto.getId());
